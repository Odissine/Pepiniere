...
from . import views
from .views import login_view, logout_view, register, error_view, lost_password, change_password, change_config, user_profil
...
urlpatterns = [
    ...
    path('profil/', user_profil, name='profil'),
