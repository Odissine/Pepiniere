...
urlpatterns = [
    ...
    path('produits/', views.export_produits, name='export_produits'),
    ...
    path('<slug:espece_slug>/<slug:variete_slug>/<slug:portegreffe_slug>/<slug:spec_slug>/', views.produit_list,
         name='produit_list_by_esp_var_pg_spec'),
]
